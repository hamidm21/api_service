...
exports.saveMessage = async (message) => {
	...
	try {
		...
		if (valid.error)
			...
			const saved = await Message.saveMessage(msg.incremental_id, room.user_id, msg.message_id, msg.room_id, msg.sender_id, msg.text, msg.timestamp, room.psychologist_id, message.highWaterOffset, msg.moment);
