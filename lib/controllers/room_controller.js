...
exports.createRoom = async (req, res, next) => {
	...
	try {
		...
		if (valid.error) {
			...
			const members = [{user_id, username: user.username, avatar: user.avatar, state: 'unpaid'}, {user_id: psychologist_id, username: psychologist.username, avatar: psychologist.avatar, state: 'subscribed'}];
