...
const config = {
	...
	SECRETARY_MSG: `سلام من ${'saba'} هستم کارشناس سایت گفتاره
	...
	PSYCHOLOGIST_MSG: ` سلام من ${'saba'} هستم 
	...
	SECRETARY_NIGHT_MSG: `سلام من ${'saba'} هستم کارشناس سایت گفتاره
	من اینجام تا شما رو به روانشناس مناسب وصل کنم همچنین در خصوص 
	عملکرد سایت به سوال های شما پاسخ بدم 
	من از ساعت ۱ تا ۸ صبح آنلاین نیستم 
	لطفا از ساعت ۸ صبح به بعد دوباره به سایت سر بزن `,
	EXPIRED_MESSAGE: `دوست عزیز مدت زمان مشاورت تموم شده 
